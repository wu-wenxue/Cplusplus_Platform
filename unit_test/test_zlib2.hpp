#ifndef TEST_ZLIB2_HPP
#define TEST_ZLIB2_HPP
...
//    test_compress(compr, comprLen, uncompr, uncomprLen);
    ...
    std::cout << "compr : " << compr << ", comprLen : " << comprLen << endl;
    std::cout << "uncompr : " << uncompr << ", uncomprLen : " << uncomprLen << endl;

    strcpy((char*)uncompr,hello);
